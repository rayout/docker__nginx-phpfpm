...
RUN apk add  --no-cache \
    php7 php7-fpm php7-common php7-mysqli php7-json php7-openssl php7-curl \
    php7-zlib php7-xml php7-simplexml php7-phar php7-intl php7-dom php7-xmlreader php7-ctype \
    php7-mbstring php7-gd php7-zip php7-exif php7-pdo php7-pdo_mysql php7-pdo_pgsql \
    php7-iconv php7-sqlite3 php7-tokenizer php7-session php7-fileinfo php7-bcmath \
    php7-xmlwriter php7-imagick php7-pcntl php7-pdo_sqlite php7-imap php7-pspell aspell-ru aspell-en
...
# Configure PHP-FPM
COPY config/php-fpm/fpm-pool.conf /etc/php7/php-fpm.d/www.conf
COPY config/php-fpm/php.ini /etc/php7/conf.d/php.ini
